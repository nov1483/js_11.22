function colderWarmer(){
    ...
    while(isNaN(firstNumber) && isNaN(secondNumber) || firstNumber === null || secondNumber === null){
    ...
    if(firstNumber < 0 || secondNumber < 0){
        ...
        return;
    }else if((firstNumber + 100) > secondNumber){
        alert(`Please enter a number greater than ${firstNumber + 100}`);
        return;
    }
    let randomNum = firstNumber + Math.floor(Math.random() * (secondNumber + 1 - firstNumber));
